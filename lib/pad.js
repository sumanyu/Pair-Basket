...
this.Pad = function Pad(id) {
  ...
  function getPosition(event) {
    ...
    val = {x: parseInt(event.gesture.center.pageX)-canvasOffset.left, y: parseInt(event.gesture.center.pageY-canvasOffset.top)};
    return val;
  }
